<template>
  <div class="group relative">
    ...
    <div class="grid gap-2 mt-2">
      <Button color-scheme="red" @click="removeFromCart">Убрать из корзины</Button>
      <Button color-scheme="secondary" @click="orderItem">Сделать заказ</Button>
    </div>
  </div>
</template>
...
const emits = defineEmits(['removeFromCart', 'orderItem'])
...
const orderItem = () => {
  emits('orderItem', props.id)
}
const removeFromCart = () => {
  emits('removeFromCart', props.id)
